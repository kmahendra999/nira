    ...
    def generate_full(
        ...
        *,
        ...
        return {
            ...
            "energy_method": telemetry_data.get("energy_method", ""),
            "energy_basis": telemetry_data.get("energy_basis", ""),
            "cpu_energy_joules": telemetry_data.get("cpu_energy_joules", 0.0),
            "gpu_energy_joules": telemetry_data.get("gpu_energy_joules", 0.0),
            "dram_energy_joules": telemetry_data.get("dram_energy_joules", 0.0),
            "ane_energy_joules": telemetry_data.get("ane_energy_joules", 0.0),
            "soc_energy_joules": telemetry_data.get("soc_energy_joules", 0.0),
