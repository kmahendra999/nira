...
dropped for nira-direct/nira-agent and ignored by terminalbench-native
...
from nira.evals.cli import _build_backend, _run_terminalbench_native
...
class TestBuildBackendForwardsEndpoint:
    @patch("nira.evals.backends.nira_direct.NiraDirectBackend")
    def test_nira_direct_receives_base_url_and_api_key(self, mock_cls):
        _build_backend(
            "nira-direct",
            "vllm",
            "orchestrator",
    ...
    @patch("nira.evals.backends.nira_agent.NiraAgentBackend")
    def test_nira_agent_receives_base_url_and_api_key(self, mock_cls):
        _build_backend(
            "nira-agent",
            "vllm",
            "orchestrator",
...
class TestTerminalBenchNativeApiBase:
    @patch("nira.evals.backends.terminalbench_native.TerminalBenchNativeBackend")
...
class TestRunSingleSuiteModeGating:
    @patch("nira.evals.cli._run_terminalbench_native")
