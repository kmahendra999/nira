...
Adapted from IPW's ``environment.py``.  Uses Nira's
:class:`~nira.tools._stubs.ToolExecutor` for real tool dispatch
...
class OrchestratorEnvironment:
    """RL environment that executes tools via Nira ``ToolExecutor``.
