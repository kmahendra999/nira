"""LLM-based optimizer for Nira configuration tuning.

Uses a cloud LLM to propose optimal Nira configs, inspired by DSPy's
...
from nira.core.types import Trace
...
class LLMOptimizer:
    """Uses a cloud LLM to propose optimal Nira configs.
    ...
    def _build_initial_prompt(self) -> str:
        ...
        lines: List[str] = []
        lines.append("You are optimizing a Nira AI system configuration.")
        lines.append("")
    ...
    def _build_analyze_prompt(
        ...
        lines: List[str] = []
        lines.append("Analyze this Nira evaluation result.")
        lines.append("")
