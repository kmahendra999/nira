...
<title>Nira — Cost Comparison</title>
<style>
...
<div class="header">
  <h1><span>Nira</span> Cost Comparison</h1>
  <div class="nav">
...
<div class="container">
  ...
  <div class="hero">
    ...
    <div class="sub">
      Nira runs models on your own hardware. Every inference call that would
...
document.getElementById('copy-btn').addEventListener('click', () => {
  const cmd = 'git clone https://github.com/nira/'
    + 'Nira.git && cd Nira && uv sync';
