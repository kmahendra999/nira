...
matrix (see ``.nira/experiments/hybrid/docs/results-table.md``).
...
from nira.agents.hybrid._prices import cost as estimate_cost
from nira.agents.hybrid._prices import default_max_output_tokens
