"""ToolTranslator — translate external tool names to Nira equivalents.

External skill libraries (Hermes Agent, OpenClaw) reference tools by Claude
Code's standard tool names (Bash, Read, Write, etc.).  Nira uses
...
# ---------------------------------------------------------------------------
# Translation table — external name → Nira name
# ---------------------------------------------------------------------------
