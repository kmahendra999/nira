...
on launch / every 30 min
        │
        ▼
GET https://github.com/nira-ai/nira/releases/download/desktop-latest/latest.json
        │
        ▼
...
curl -fsSL https://github.com/nira-ai/nira/releases/download/desktop-latest/latest.json | jq .
