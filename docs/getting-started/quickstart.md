...
|--------|-----|-------------|
| [`chat-simple.toml`](https://github.com/nira-ai/nira/blob/main/configs/nira/examples/chat-simple.toml) | Any machine | Lightweight chat, no tools -- simplest setup |
| [`code-assistant.toml`](https://github.com/nira-ai/nira/blob/main/configs/nira/examples/code-assistant.toml) | Any machine | Orchestrator agent with code execution, file I/O, shell |
| [`deep-research.toml`](https://github.com/nira-ai/nira/blob/main/configs/nira/examples/deep-research.toml) | Any machine | Multi-hop research across indexed documents with citations |
| [`scheduled-monitor.toml`](https://github.com/nira-ai/nira/blob/main/configs/nira/examples/scheduled-monitor.toml) | Any machine | Persistent operative agent on a cron schedule |
| [`morning-digest-mac.toml`](https://github.com/nira-ai/nira/blob/main/configs/nira/examples/morning-digest-mac.toml) | Mac (Apple Silicon) | Daily spoken briefing from email, calendar, health, news |
| [`morning-digest-linux.toml`](https://github.com/nira-ai/nira/blob/main/configs/nira/examples/morning-digest-linux.toml) | Linux / GPU server | Same, with vLLM support |
| [`morning-digest-minimal.toml`](https://github.com/nira-ai/nira/blob/main/configs/nira/examples/morning-digest-minimal.toml) | Any machine | Just Gmail + Calendar |
