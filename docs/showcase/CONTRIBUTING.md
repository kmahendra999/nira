...
description: How to add your setup to the Nira Showcase
---

# Contributing a Showcase Entry

The Showcase exists for one reason: to help a confused, curious, *non-technical* reader figure out whether Nira is worth their weekend. That goal sets every editorial choice on this page.
...
→ **[Recipe: <name>](https://github.com/kmahendra999/nira/tree/main/src/nira/recipes/data)** if you want the exact config.
...
✅ "Nira answers my Discord messages while I sleep."
...
Hannah and the docs team post merged showcase entries to **`#config-showcase`** in [the Nira Discord](https://discord.gg/nira). You'll get tagged in the post — you don't have to do it yourself.
