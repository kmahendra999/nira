...
The default path is `~/.nira/audit.db`, configurable via `security.audit_log_path` in `config.toml`.
...
- [API Reference: Security](../api-reference/nira/security/index.md) — complete class and function signatures
