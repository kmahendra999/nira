...
```python
from nira.intelligence import merge_discovered_models
...
The following names are still importable from `nira.intelligence` via shim modules, but their canonical locations have moved:
