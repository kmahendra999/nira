...
Nira is a research framework for composable, on-device AI systems.
...
=== "Desktop App"
    ...
    The desktop app is a native window for the Nira UI.
    ...
    **Step 2.** Download and open the desktop app:
    ...
    !!! warning "macOS first launch"
        ...
        Run `xattr -cr /Applications/Nira.app` if the app shows as "damaged".
...
Nira is built around five composable layers. Each has a clean interface and can be swapped independently.

1. **Intelligence** — Pick a model, or let Nira pick one for your hardware. Manages the full catalog of local models across providers.
...
-   **OpenAI-Compatible API**
    ...
    `nira serve` starts a FastAPI server with SSE streaming. Drop-in replacement for OpenAI clients.
...
-   **[Getting Started](getting-started/installation.md)**
    ...
    Install Nira, configure your first engine, and run your first query.
...
-   **[API Reference](api-reference/nira/index.md)**
