...
use nira_core::error::NiraError;
use nira_core::{EventBus, EventType, GenerateResult, Message};
use nira_engine::traits::{InferenceEngine, TokenStream};
    ...
    fn handle_findings(
        ...
        match self.mode {
            ...
            RedactionMode::Block => {
                ...
                Err(NiraError::Security(
                    nira_core::error::SecurityError::Blocked(format!(
...
mod tests {
    ...
    fn test_guardrails_block_mode() {
        ...
        let err = guardrails
            .generate(&[Message::user("Hi")], "mock", 0.7, 100, None)
            .unwrap_err();
        assert!(matches!(err, NiraError::Security(_)));
    }
}
