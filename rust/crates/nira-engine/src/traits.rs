...
use nira_core::{GenerateResult, Message, Role};
use serde_json::Value;
use std::pin::Pin;
use tokio_stream::Stream;

pub type StreamItem = Result<String, nira_core::NiraError>;
...
pub trait InferenceEngine: Send + Sync {
    ...
    fn generate(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<GenerateResult, nira_core::NiraError>;
    ...
    async fn stream(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<TokenStream, nira_core::NiraError>;

    fn list_models(&self) -> Result<Vec<String>, nira_core::NiraError>;
...
mod tests {
    use super::*;
    use nira_core::{Message, ToolCall};
