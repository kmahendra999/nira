...
impl PyAgentCard {
    ...
    fn new(name: &str, description: &str, version: &str, url: &str) -> Self {
        Self {
            inner: nira_a2a::AgentCard::new(name, description, version, url),
        }
    }
...
impl PyA2ATaskStore {
    ...
    fn new() -> Self {
        Self {
            inner: nira_a2a::A2ATaskStore::new(),
        }
    }
...
pub fn parse_a2a_request(json_str: &str) -> PyResult<String> {
    let req = nira_a2a::parse_request(json_str)
