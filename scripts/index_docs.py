#!/usr/bin/env python3
"""Index Nira docs (README.md + docs/**/*.md) into a DenseMemory backend.
...
def build_index(
    ...
    *,
    ...
    dedupe: bool = True,
    # Empirical: on the actual Nira docs the boilerplate that
    # crowds retrieval ("Nira runs entirely on your hardware...")
...
def main() -> int:
    ...
    queries = args.query or [
        ...
        "what inference engines does nira support?",
