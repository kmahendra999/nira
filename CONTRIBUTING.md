...
Look for issues labeled [`good-first-issue`](https://github.com/kmahendra999/nira/labels/good-first-issue).
...
Use the appropriate [issue template](https://github.com/kmahendra999/nira/issues/new/choose):
