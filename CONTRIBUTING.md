...
Thank you for your interest in contributing to Nira! This guide covers everything you need to know — from why to contribute, to how to submit your first pull request.

---

## Why Contribute?

Contributing to Nira isn't just about code — it's about building the future of on-device AI together. Here's what you get:

### Paper Acknowledgment

All contributors with merged pull requests will be acknowledged as contributors on the Nira paper release.
...
See the [Savings Leaderboard](https://nira-ai.github.io/nira/leaderboard/) for details.
...
Look for issues labeled [`good-first-issue`](https://github.com/nira-ai/nira/labels/good-first-issue).
...
1. Browse the [Roadmap](https://nira-ai.github.io/nira/development/roadmap/) for an item that interests you
2. Check if a [GitHub issue](https://github.com/nira-ai/nira/issues) already exists for it — if not, [open one](https://github.com/nira-ai/nira/issues/new/choose) describing what you'd like to work on
...
Use the appropriate [issue template](https://github.com/nira-ai/nira/issues/new/choose):
...
Nira is built on five composable primitives. Here's where you can contribute:
...
- Open a [Discussion](https://github.com/nira-ai/nira/discussions) for questions and help
- Check the [documentation](https://nira-ai.github.io/nira/) for guides and API reference
