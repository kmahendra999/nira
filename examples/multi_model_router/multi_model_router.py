...
def main() -> None:
    ...
    # Initialize Nira to discover available models
    try:
        j = Nira(engine_key=args.engine)
    ...
    if args.strategy == "bandit":
        from nira.learning.routing.learned_router import LearnedRouterPolicy
