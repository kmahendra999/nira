...
Index a directory of documents into Nira memory and answer questions
...
1. **Index** -- Uses `Nira.memory.index()` to chunk the documents at
...
Nira SDK. Adjust `--chunk-size` and `--top-k` to tune the
