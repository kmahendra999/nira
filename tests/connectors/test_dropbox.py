...
def connector(tmp_path: Path):
    ...
    from nira.connectors.dropbox import DropboxConnector  # noqa: PLC0415
...
@patch("nira.connectors.dropbox._dropbox_api_list_folder")
@patch("nira.connectors.dropbox._dropbox_api_download")
