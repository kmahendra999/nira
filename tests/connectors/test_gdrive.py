...
def connector(tmp_path: Path):
    ...
    from nira.connectors.gdrive import GDriveConnector  # noqa: PLC0415
...
@patch("nira.connectors.gdrive._gdrive_api_list_files")
@patch("nira.connectors.gdrive._gdrive_api_export")
