...
_LOCAL_CONNECTORS = [
    ("apple_notes", "nira.connectors.apple_notes", "AppleNotesConnector"),
    ("imessage", "nira.connectors.imessage", "IMessageConnector"),
]

_TOKEN_CONNECTORS = [
    ("gmail_imap", "nira.connectors.gmail_imap", "GmailIMAPConnector"),
    ("outlook", "nira.connectors.outlook", "OutlookConnector"),
    ("slack", "nira.connectors.slack_connector", "SlackConnector"),
    ("notion", "nira.connectors.notion", "NotionConnector"),
    ("granola", "nira.connectors.granola", "GranolaConnector"),
    ("gdrive", "nira.connectors.gdrive", "GDriveConnector"),
    ("gcalendar", "nira.connectors.gcalendar", "GCalendarConnector"),
    ("gcontacts", "nira.connectors.gcontacts", "GContactsConnector"),
    ("dropbox", "nira.connectors.dropbox", "DropboxConnector"),
]
