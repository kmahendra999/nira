...
from nira.agents._stubs import AgentResult  # noqa: E402
from nira.core.events import EventBus  # noqa: E402
from nira.core.types import ToolResult  # noqa: E402
from nira.server.models import ChatCompletionRequest  # noqa: E402
from nira.server.stream_bridge import AgentStreamBridge  # noqa: E402
...
def test_stream_replays_grounded_agent_result_without_second_inference():
    grounded_content = "My name is Nira. The tool reports 72 degrees."
    agent = MagicMock()
