...
class TestGetRustModule:
    ...
    def test_returns_rust_module(self):
        """get_rust_module() returns the nira_rust module."""
        ...
        assert result.__name__ == "nira_rust"
...
class TestScanResultFromJson:
    ...
    def test_empty_findings(self):
        from nira._rust_bridge import scan_result_from_json
...
class TestRetrievalResultsFromJson:
    ...
    def test_empty(self):
        from nira._rust_bridge import retrieval_results_from_json
...
class TestRustBackedModules:
    ...
    def test_rate_limiter_uses_rust(self):
        ...
        from nira.security.rate_limiter import RateLimiter
