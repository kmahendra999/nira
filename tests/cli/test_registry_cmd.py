"""Tests for the ``nira registry`` CLI commands."""
...
class TestRegistryCmd:
    """Test cases for the nira registry CLI group."""
    ...
    def test_registry_show_handles_exception(self) -> None:
        ...
        with patch(
            "nira.core.registry.ToolRegistry.keys",
    ...
    def test_registry_show_handles_error_during_import(self) -> None:
        ...
        with patch.dict("sys.modules", {"nira.core.registry": None}):
