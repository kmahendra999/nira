...
class TestOperativeAgent:
    def test_init_defaults(self):
        ...
        engine = FakeEngine()
        with patch(
            "nira.agents._stubs.load_config",
...
class TestOperatorsConfig:
    def test_config_defaults(self):
        from nira.core.config import OperatorsConfig
    ...
    def test_config_in_nira_config(self):
        from nira.core.config import NiraConfig
...
class TestLoadBundledOperators:
    ...
    def operators_dir(self):
        ...
        ops_dir = project_root / "src" / "nira" / "operators" / "data"
