"""Smoke tests for ``nira optimize`` and ``nira feedback`` CLI commands,
...
class TestOptimizeConfig:
    """Tests for OptimizeConfig in NiraConfig."""

    def test_optimize_config_in_nira_config(self):
        from nira.core.config import NiraConfig, OptimizeConfig
    ...
    def test_optimize_config_defaults(self):
        from nira.core.config import OptimizeConfig
