"""Tests for nira.optimize.trial_runner module."""
...
from nira.learning.optimize.trial_runner import TrialRunner
from nira.learning.optimize.types import TrialConfig, TrialResult
...
class TestBuildRunConfig:
    ...
    def test_no_agent_maps_to_direct_backend(self) -> None:
        ...
        assert cfg.backend == "nira-direct"
...
class TestRunTrial:
    ...
    @patch("nira.evals.cli._build_scorer")
    @patch("nira.evals.cli._build_judge_backend")
    @patch("nira.evals.cli._build_dataset")
    @patch("nira.evals.cli._build_backend")
    @patch("nira.evals.core.runner.EvalRunner")
    ...
    def test_run_trial_populates_sample_scores(
        ...
        from nira.evals.core.types import EvalResult
