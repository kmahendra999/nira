"""Tests for nira.learning.spec_search.execute.base module."""
...
class TestApplyContext:
    ...
    def test_constructs(self, tmp_path: Path) -> None:
        ...
        ctx = ApplyContext(nira_home=tmp_path, session_id="s1")
        assert ctx.nira_home == tmp_path
...
class TestValidationResult:
    ...
    def test_ok_result(self) -> None:
        from nira.learning.spec_search.execute.base import ValidationResult
