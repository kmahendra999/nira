"""Tests for nira.learning.spec_search.plan.risk_tier module."""
...
class TestTierTable:
    ...
    def test_every_edit_op_has_a_tier(self) -> None:
        ...
        from nira.learning.spec_search.plan.risk_tier import TIER_TABLE
...
class TestAssignTier:
    ...
    def test_intelligence_ops_are_auto(self) -> None:
        from nira.learning.spec_search.models import EditOp, EditRiskTier
        from nira.learning.spec_search.plan.risk_tier import assign_tier
...
class TestAssignTiers:
    ...
    def test_overwrites_teacher_tier(self) -> None:
        ...
        from nira.learning.spec_search.plan.risk_tier import assign_tiers
