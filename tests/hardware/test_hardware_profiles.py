...
class TestDetectHardware:
    ...
    @patch("nira.core.config.shutil.which", return_value="/usr/bin/nvidia-smi")
    @patch(
        "nira.core.config._run_cmd",
    ...
    @patch("nira.core.config.shutil.which", return_value="/usr/bin/rocm-smi")
    @patch(
        "nira.core.config._run_cmd",
        side_effect=[
    ...
    @patch("nira.core.config.platform.system", return_value="Darwin")
    @patch(
        "nira.core.config._run_cmd",
        return_value=(
            "Graphics/Displays:\n"
    ...
    @patch("nira.core.config.shutil.which", return_value=None)
    @patch("nira.core.config.platform.system", return_value="Linux")
