...
from nira.skills.index import SkillIndex
...
class TestSkillIndex:
    def test_load_index(self, tmp_path: Path):
        ...
        index_file.write_text(
            ...
            author = "nira"
            source = "github.com/nira/skills/research"
            sha256 = "abc123"
            tags = ["research"]
    ...
    def test_search_by_name(self, tmp_path: Path):
        ...
        index_file.write_text(
            ...
            author = "nira"
            source = "github.com/nira/skills/web_research"
            sha256 = "abc"
            tags = ["research"]
            required_capabilities = []
            ...
            author = "nira"
            source = "github.com/nira/skills/code_review"
            sha256 = "def"
            tags = ["coding"]
            required_capabilities = []
        """)
