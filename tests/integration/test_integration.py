...
from nira.core.registry import AgentRegistry, RouterPolicyRegistry, ToolRegistry
...
class TestAskFlowWithRouterPolicy:
    ...
    def test_mocked_ask_with_registry_router(self):
        from nira.learning._stubs import RoutingContext
        from nira.learning.routing.heuristic_policy import ensure_registered
        from nira.learning.routing.router import HeuristicRouter
...
class TestSDKImport:
    """Verify Nira class is importable from nira."""

    def test_nira_imports(self):
        from nira import Nira

        assert Nira is not None
...
class TestSDKAskFlow:
    ...
    def test_sdk_ask_e2e(self):
        ...
        with patch("nira.sdk.get_engine", return_value=("mock", engine)):
            j = Nira(config=NiraConfig(), model="test-model")
...
class TestSDKMemoryHandle:
    ...
    def test_index_and_search(self, tmp_path):
        from nira.core.config import NiraConfig
        from nira.sdk import MemoryHandle
...
class TestBenchmarkRegistryDiscovery:
    ...
    def test_discovers_benchmarks(self):
        from nira.bench import ensure_registered
...
class TestBenchmarkSuiteRunAll:
    ...
    def test_suite_produces_jsonl(self):
        ...
        from nira.bench import ensure_registered
        from nira.bench._stubs import BenchmarkSuite
        from nira.core.registry import BenchmarkRegistry
...
class TestFullPipeline:
    ...
    def test_full_pipeline(self, tmp_path):
        ...
        with patch("nira.sdk.get_engine", return_value=("mock", engine)):
            j = Nira(config=cfg, model="test-model")
