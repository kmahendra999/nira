...
from nira.tools.code_interpreter import _validate_ast
...
class TestCodeInterpreterValidation:
    ...
    def test_limit_failure_does_not_skip_later_hardening(self, monkeypatch):
        ...
        from nira.tools.code_interpreter import _child_limits
        ...
        setsid = MagicMock()
        monkeypatch.setattr("nira.tools.code_interpreter.os.setsid", setsid)
