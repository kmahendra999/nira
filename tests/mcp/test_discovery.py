...
_PATCH_HTTP = "nira.mcp.transport.StreamableHTTPTransport"
_PATCH_STDIO = "nira.mcp.transport.StdioTransport"
_PATCH_CLIENT = "nira.mcp.client.MCPClient"
_PATCH_PROVIDER = "nira.tools.mcp_adapter.MCPToolProvider"
_PATCH_LOGGER = "nira.system.builder.logger"
...
def test_builder_retains_full_mcp_pool_for_managed_agents() -> None:
    ...
    with (
        patch("nira.mcp.server.MCPServer") as mcp_server_cls,
        patch.object(
            builder,
...
def test_builder_wires_security_context_into_internal_mcp_server() -> None:
    ...
    with patch("nira.mcp.server.MCPServer") as mcp_server_cls:
        mcp_server_cls.return_value.get_tools.return_value = []
