...
from nira.agents.hybrid.skillorchestra.agent import SkillOrchestraAgent
from nira.agents.hybrid.skillorchestra.pool import ModelSpec
from nira.agents.hybrid.skillorchestra.tools import run_code, run_search
...
def test_enhance_reasoning_denial_prevents_python_subprocess(monkeypatch):
    from nira.agents.hybrid.skillorchestra import tools as tools_module
