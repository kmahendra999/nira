...
from nira.evals.cli import BACKENDS, _build_backend
...
class TestBuildBackendDispatch:
    def test_backends_dict_includes_external(self) -> None:
        ...
        assert "nira-agent" in BACKENDS
        assert "nira-direct" in BACKENDS
    ...
    def test_hermes_returns_hermes_backend(self) -> None:
        ...
        with (
            ...
            patch("nira.evals.backends.external.hermes_agent.verify_commit_pin"),
        ):
