...
def table_gen():
    ...
    from nira.evals.comparison.table_gen import _build_t1, load_results
...
class TestExportToTableGenRoundtrip:
    ...
    def test_table_gen_builds_t1_from_export_schema(
        ...
        for fwk, acc in [("hermes", 0.30), ("nira", 0.45)]:
            summary = {
                "framework": fwk,
...
class TestSummaryToDictEmitsRequiredFields:
    ...
    def test_summary_to_dict_includes_table_gen_fields(self) -> None:
        ...
        from nira.evals.core.types import EvalResult, RunSummary
...
class TestExportSummaryJsonEmitsRequiredFields:
    ...
    def test_export_summary_includes_table_gen_fields(self, tmp_path: Path) -> None:
        from nira.evals.core.export import export_summary_json
