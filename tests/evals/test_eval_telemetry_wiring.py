...
- NiraDirectBackend propagates gpu_metrics flag
...
from nira.evals.core.types import EvalResult, RunConfig, RunSummary
...
class TestSummaryToDict:
    ...
    def test_telemetry_summary_present(self):
        from nira.evals.core.runner import _summary_to_dict
...
class TestResultToTraceDict:
    ...
    def test_estimated_flops_in_trace(self):
        from nira.evals.core.runner import _result_to_trace_dict
...
# ---------------------------------------------------------------------------
# NiraDirectBackend gpu_metrics propagation
# ---------------------------------------------------------------------------


class TestDirectBackendGpuMetrics:
    """Verify NiraDirectBackend sets gpu_metrics on config."""
...
class TestTauBenchTelemetryPassthrough:
    ...
    @patch("nira.evals.execution.taubench_env.TauBenchTaskEnv")
