...
PROVIDERS = [
    ("nira.evals.datasets.pinchbench", "PinchBenchDataset"),
    ("nira.evals.datasets.liveresearch", "LiveResearchBenchDataset"),
    ("nira.evals.datasets.gaia", "GAIADataset"),
    ("nira.evals.datasets.liveresearchbench", "LiveResearchBenchDataset"),
    ("nira.evals.datasets.taubench", "TauBenchDataset"),
    ("nira.evals.datasets.toolcall15", "ToolCall15Dataset"),
    ("nira.evals.datasets.livecodebench", "LiveCodeBenchDataset"),
]
