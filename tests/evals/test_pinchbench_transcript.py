...
from nira.evals.core.event_recorder import AgentEvent, EventType
from nira.evals.core.trace import TurnTrace
...
def test_events_to_transcript_tool_call_pair():
    ...
    from nira.evals.scorers.pinchbench import events_to_transcript
...
def test_events_to_transcript_tool_name_mapping():
    """Nira tool names are mapped to PinchBench-expected names."""
    from nira.evals.scorers.pinchbench import events_to_transcript
