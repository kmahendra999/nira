...
def recording_mkdtemp(*args, **kwargs):
    ...
    if kwargs.get("prefix") == "nira-test-home-":
        created.append(path)
    return path

tempfile.mkdtemp = recording_mkdtemp
os.environ["NIRA_HOME"] = "/tmp/nira-original-home-sentinel"
os.environ["NIRA_CONFIG"] = "/tmp/nira-original-config-sentinel"
...
assert os.environ["NIRA_HOME"] == "/tmp/nira-original-home-sentinel"
assert os.environ["NIRA_CONFIG"] == "/tmp/nira-original-config-sentinel"
