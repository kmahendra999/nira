...
from nira.core.registry import CompressionRegistry
...
def _register_compressors():
    ...
    from nira.sessions.compression import (
        ModelSummarization,
...
def test_rule_based_strips_tool_boilerplate():
    from nira.sessions.compression import RuleBasedPrecompression
...
def test_session_consolidation_preserves_recent():
    from nira.sessions.compression import SessionConsolidation
...
def test_tiered_summaries_gradient():
    from nira.sessions.compression import TieredSummaries
