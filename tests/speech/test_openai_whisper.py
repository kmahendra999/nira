...
from nira.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_transcribe():
    ...
    with patch("nira.speech.openai_whisper.OpenAI", return_value=mock_client):
        from nira.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_health():
    with patch("nira.speech.openai_whisper.OpenAI"):
        from nira.speech.openai_whisper import OpenAIWhisperBackend
