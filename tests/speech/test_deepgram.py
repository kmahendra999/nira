...
from nira.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_transcribe():
    ...
    with patch("nira.speech.deepgram.DeepgramClient", return_value=mock_client):
        from nira.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_health():
    with patch("nira.speech.deepgram.DeepgramClient"):
        from nira.speech.deepgram import DeepgramSpeechBackend
