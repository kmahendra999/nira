...
def test_get_speech_backend_explicit():
    ...
    with patch("nira.speech._discovery._create_backend") as mock_create:
        mock_backend = type(
            "MockBackend",
            (),
            {
...
def test_auto_discovery_priority():
    ...
    from nira.speech._discovery import DISCOVERY_ORDER
...
def test_auto_discovery_skips_unhealthy_backend() -> None:
    ...
    with patch(
        "nira.speech._discovery._create_backend",
