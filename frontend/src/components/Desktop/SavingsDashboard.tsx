...
const OPTIN_KEY = 'nira-desktop-optin';
const OPTIN_NAME_KEY = 'nira-desktop-display-name';
const OPTIN_EMAIL_KEY = 'nira-desktop-email';
const OPTIN_ANONID_KEY = 'nira-desktop-anon-id';
