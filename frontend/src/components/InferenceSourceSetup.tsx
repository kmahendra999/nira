      ...
      <div className="flex items-start gap-3 mb-5">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed" style={{ color: 'var(--color-text-secondary)' }}>
            Nira will start Ollama and may download one model selected for this computer. Model downloads can use several gigabytes of disk space and network data.
          </p>
        </div>
      </div>
      <div
      ...
      <form onSubmit={submit} className="flex flex-col gap-4">
        <div>
          ...
          <p className="text-xs" style={{ color: 'var(--color-text-secondary)' }}>
            Nira will connect only after you submit this form. Ollama will not start or download models.
          </p>
        </div>
